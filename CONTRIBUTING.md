...
git clone https://github.com/YOUR_USERNAME/HIPAA-Training-System-for-Pharmacy-Staff.git
cd HIPAA-Training-System-for-Pharmacy-Staff
```
...
python -m unittest test_hipaa_training.TestClassName

# Run specific test method
python -m unittest test_hipaa_training.TestClassName.test_method_name
