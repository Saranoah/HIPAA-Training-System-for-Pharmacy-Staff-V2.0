...
class DatabaseManager:
    ...
    def _get_connection(self):
        """Database connection context manager with proper commit/rollback"""
    ...
    def save_progress(self, user_id: int, lesson_title: str, score=None, checklist_data=None):
    ...
    def save_sensitive_progress(self, user_id: int, checklist_data, score=None):
    ...
    def create_user(self, username: str, full_name: str, role: str) -> int:
        ...
        with self.db._get_connection() as conn:
            try:
                ...
                self.security.log_action(
                    user_id, "USER_CREATED", f"Username: {username}, Role: {role}"
                )
                return user_id
